...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice teamwork and compete against other schools in basketball",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "samantha@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and relay events for all skill levels",
    ...
    "Math Olympiad": {
        "description": "Practice advanced problem solving and prepare for math competitions",
